<div class="bg-while">
  <?php
  echo albumBannerSlide(7);
  $page       =   $page + 0;
  $perpage    =   100;
  $r_all      =   $db->selectpost(
    "hien_thi=1 and type='2' and post_type='sanpham_detail' and lang_id='" . $lang_code . "'",
    ""
  );
  ...
  <div class="mt30">
    <div class="container">
      ...
      <?php
      $q = $db->selectpost("hien_thi=1 and type='2' and post_type='sanpham_detail' and lang_id='" . $lang_code . "'", "order by post.time_edit LIMIT " . $min . ", " . $max);
      if ($db->num_rows($q) != 0) {
      ?>
        <div class="row">
          <?php
