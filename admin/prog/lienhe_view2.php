            ...
            <div class="box-common box-danger">
                ...
                <input type="hidden" name="id" value="<?=$id?>" />
                    <div class="detail-box">
                        ...
                        <ul>
                            <?if($row['post_id']!=0){?>
                            <li><strong>Tên dự án:</strong> <b style="text-transform: uppercase;"><?=get_sql("select ten from post_lang where post_id=".$row["post_id"])?></b></li>
                            <!-- <li><strong>Mã BĐS:</strong> <b style="text-transform: uppercase;">1280-<?=$row["post_id"]?></b></li> -->
                            <!-- <?}?>
                            ...
                            <?if($row['ten']!=''){?><li><strong>Email :</strong> <?=$row['email']?></li><?}?>
                            <li><strong>Thời gian :</strong> <?=lg_date::vn_time($row["time"])?></li>
                        </ul>
