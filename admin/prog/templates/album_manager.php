<?
function	template_edit($url,$func,$id,$txt_cat,$txt_ten,$txt_hien_thi,$sp_id,$txt_hinh,$txt_chu_thich,$post_type,$error)
{
?>
            ...
            <table class="table table-striped">
                <tbody>
                    <tr>
                        ...
                        <?
                        global $db;
                        $q1=$db->select("post_album_menu","id='".$id."'","");
                        $r1=$db->fetch($q1);
                        {
                        ?>
                        <p style="text-align: center;background: #fff;margin: 10px 0;">
                            <img src="../uploads/<?=$r1['dir'].$r1['hinh']?>" style="max-width: 400px;" alt="<?=$r1['ten']?>"  />
                        </p>
                        <?}?>
                        </td>
                        <td>
...
$r2 = $db->select("vn_cat","_anhsp = 1","order by thu_tu asc");
?>
