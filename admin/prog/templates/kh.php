<?
function	template_edit($url,$func,$id,$txt_ten,$txt_address,$txt_tel,$txt_email,$txt_status,$txt_yeu_cau,$txt_noi_dung,$txt_time,$txt_congty,$txt_thanhtoan,$txt_ma,$cod,$activate,$error)
{
?>
...
<input type="hidden" name="func" value="<?=$func?>" />
    ...
    <fieldset class="bg-form">
        ...
        <div class="title_donhang">Mã đơn hàng: <b style="font-size: 20px;"><?=$txt_ma?> </b> | Ngày xuất đơn hàng: <?=date('d/m/Y');?></div>

        <div class="form-group check-tinhtrang" style="text-align: center;margin-top: 20px;">
            <label class="control-label">Mã COD</label><br />
            <input style="text-align: center;font-size: 18px;letter-spacing: 4px;border: none;padding: 5px 0;" disabled="" readonly="" name="cod" type="text" value="<?=$cod?>"/>
        </div>
        <div class="form-group check-tinhtrang" style="text-align: center;">
            <input name="activate" type="radio" value="0" <?=$activate==0?"checked":""?> /><span class="do">Chưa activate</span>
            <input name="activate" type="radio" value="1" <?=$activate==1?"checked":""?> /><span class="xanh">Đã activate</span>
        </div>
