            ...
            <div class="box-common box-danger">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?php
                            $rt = $db->select("lienhe","type='' and post_id<>0","");
                            $rowt = $db->num_rows($rt);
                            echo $rowt." active";
                        ?>
                        </span>
                ...
                <div class="paddinglr10">
                    <div class="table-responsive">
                        ...
                        <tbody>
                        <?php
                        $q=$db->select("lienhe","type='' and post_id<>0","order by id desc");
                        while ($r = $db->fetch($q))
                        {
                        ?>
                        <tr style="background-color:<?if($r['view']==1){echo 'rgba(243,243,243,.85)';}?>">
                            <td><b><?php echo get_sql("select ten from post_lang where post_id=".$r['post_id']); ?></b></td>
                            <td>
                                <?=$r["ten"]?>
                            </td>
                            <td><?=$r["email"]?></td>
                            ...
                            <td><a onclick="setview('lienhe',<?=$r["id"]?>)" href="?act=lienhe_view2&id=<?=$r["id"]?>">Xem chi tiết</a></td>
