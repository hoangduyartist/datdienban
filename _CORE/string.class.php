...
{
//	Public function
	public static	function	crop($text,$qty)
	{
		$txt			=	$text;
	...
	public static	function	cut($text,$qty)
	{
		$txt			=	$text;
	...
	public static	function	check_email($txt_email)
	{
		return (ereg("[A-Za-z0-9_-]+([\.]{1}[A-Za-z0-9_-]+)*@[A-Za-z0-9-]+([\.]{1}[A-Za-z0-9-]+)+", $txt_email));
	}
	
	public static	function	analyse_url($url)
	{
		$qr	=	stristr($url,"?");
		$qr	=	trim($qr,"?");
		$x	=	explode("&",$qr);
	...
	public static	function	get_link($txt)
	{
	...
	public static	function	bo_dau($txt)
	{
		return self::UNI_2_TXT($txt);
	}
//	Private function
	public static function	UNI_2_TXT ( $text )
	{
	...
	public static function	UNI_2_TCVN3 ( $text )
	{
