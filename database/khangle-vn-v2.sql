...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 10, 2020 lúc 03:48 AM
...
(19, 'Tran', 'Da anang', '0968888888', 'email@gmail.com', 'asdasdasdasdas', '<table><tr><th style=\"padding:10px;border: 1px solid #ccc\">TÃªn</th><th style=\"padding:10px;border: 1px solid #ccc\">GiÃ¡</th><th style=\"padding:10px;border: 1px solid #ccc\">Sá»‘ lÆ°á»£ng</th><th style=\"padding:10px;border: 1px solid #ccc\">Tá»•ng cá»™ng</th></tr><tr><td style=\"padding:10px;border: 1px solid #ccc\"><div><p style=\"text-transform: uppercase;display: block;margin-bottom: 10px;\">Demo Fashion</p><ul><li>SIZE: Xl</li></ul></div></td><td style=\"padding:10px;border: 1px solid #ccc\">89 <sup>Ä‘/sp</sup></td><td style=\"padding:10px;border: 1px solid #ccc\">1</td><td style=\"padding:10px;border: 1px solid #ccc\">89 <sup>Ä‘</sup></td></tr><tr><td style=\"padding:10px;border: 1px solid #ccc\"><div><p style=\"text-transform: uppercase;display: block;margin-bottom: 10px;\">Demo Fashion</p><ul><li>SIZE: xxl</li></ul></div></td><td style=\"padding:10px;border: 1px solid #ccc\">89 <sup>Ä‘/sp</sup></td><td style=\"padding:10px;border: 1px solid #ccc\">4</td><td style=\"padding:10px;border: 1px solid #ccc\">356 <sup>Ä‘</sup></td></tr><tr><td style=\"padding:10px;border: 1px solid #ccc\"><div><p style=\"text-transform: uppercase;display: block;margin-bottom: 10px;\">Demo Fashion</p><ul><li>SIZE: sm</li></ul></div></td><td style=\"padding:10px;border: 1px solid #ccc\">89 <sup>Ä‘/sp</sup></td><td style=\"padding:10px;border: 1px solid #ccc\">1</td><td style=\"padding:10px;border: 1px solid #ccc\">89 <sup>Ä‘</sup></td></tr><tr><td colspan=\"3\" style=\"padding:10px;border: 1px solid #ccc\"><b>Tá»•ng cá»™ng </b><br /></td><td style=\"padding:10px;border: 1px solid #ccc\"><b style=\"font-weight: bold; font-size: 15px; color: #ff0000;\">534 <sup>Ä‘</sup></b></td></tr></table>', 1590230658, 0, 534, '', '', '', 4);
...
--
-- Cấu trúc bảng cho bảng `media_folder`
--

CREATE TABLE `media_folder` (
  `id` int(10) NOT NULL,
  `folder_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `folder_description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_display` tinyint(1) NOT NULL DEFAULT '1',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `media_folder`
--

INSERT INTO `media_folder` (`id`, `folder_name`, `folder_description`, `is_display`, `is_deleted`) VALUES
(1, 'thu-muc-chua-hinh-nong', 'ThÆ° má»¥c chá»©a hÃ¬nh nÃ³ng', 1, 0),
(2, 'thu-muc-co-hinh-lanh', 'ThÆ° má»¥c cÃ³ hÃ¬nh láº¡nh', 1, 0),
(3, 'thu-muc-vui-thoi', 'ThÆ° má»¥c vui thÃ´i', 1, 0);
...
(5, 8, 0, 0, 1589016466, 1589016466, 0, 1589016466, '5', '5', 4, 1, 1, 0, 'news_detail', 0, 0, '', 1, 0, 0, 0, 0, '', '', ''),
(6, 8, 0, 0, 1589016476, 1589016476, 0, 1589016476, '5', '5', 2, 1, 1, 0, 'news_detail', 0, 0, '', 1, 0, 0, 0, 0, '', '', ''),
(7, 9, 0, 0, 1589016586, 1588957200, 0, 0, '5', '5', 18, 1, 1, 0, 'news_detail', 0, 0, '', 1, 0, 0, 0, 0, '0', '0', ''),
(8, 9, 0, 0, 1589016884, 1589016884, 0, 1589016884, '5', '5', 2, 1, 1, 0, 'news_detail', 0, 0, '', 1, 0, 0, 0, 0, '', '', ''),
(9, 12, 4, 0, 1589045770, 1589043600, 0, 0, '5', '5', 464, 1, 0, 0, 'sanpham_detail', 0, 0, '', 1, 0, 0, 1, 0, '2', '0', ''),
...
(13, 12, 4, 0, 1589128837, 1589043600, 0, 0, '5', '5', 1, 1, 0, 0, 'sanpham_detail', 0, 0, '', 1, 0, 0, 1, 0, '1', '0', ''),
(14, 12, 4, 0, 1589128845, 1589043600, 0, 0, '5', '5', 0, 1, 0, 0, 'sanpham_detail', 0, 0, '', 1, 0, 0, 0, 0, '1', '0', ''),
(15, 13, 4, 0, 1589128859, 1589043600, 0, 0, '5', '5', 0, 1, 0, 0, 'sanpham_detail', 0, 0, '', 1, 0, 0, 0, 0, '0', '0', ''),
(16, 12, 4, 0, 1589128862, 1589043600, 0, 0, '5', '5', 0, 1, 0, 0, 'sanpham_detail', 0, 0, '', 1, 0, 0, 0, 0, '1', '0', ''),
(17, 12, 4, 0, 1589128879, 1589043600, 0, 0, '5', '5', 3, 1, 0, 0, 'sanpham_detail', 0, 0, '', 1, 0, 0, 0, 0, '1', '0', ''),
(18, 12, 4, 0, 1589128886, 1589043600, 0, 0, '5', '5', 11, 1, 0, 0, 'sanpham_detail', 0, 0, '', 1, 0, 0, 1, 0, '2', '0', ''),
...
(32, 24, 0, 0, 1593780203, 1593780203, 0, 1593780203, '5', '5', 0, 1, 1, 0, 'news_detail', 0, 0, '', 0, 0, 0, 0, 0, '0', '0', ''),
(33, 24, 0, 0, 1593780207, 1593780207, 0, 1593780207, '5', '5', 0, 1, 1, 0, 'news_detail', 0, 0, '', 0, 0, 0, 0, 0, '0', '0', ''),
(34, 24, 0, 0, 1593780213, 1593780213, 0, 1593780213, '5', '5', 3, 1, 1, 0, 'news_detail', 0, 0, '', 0, 0, 0, 0, 0, '0', '0', ''),
(35, 24, 0, 0, 1593780228, 1593709200, 0, 0, '5', '5', 110, 1, 1, 0, 'news_detail', 0, 0, '', 0, 0, 0, 0, 0, '0', '0', '');
...
(18, 4, 1, 0, 0, 2, 'sanpham', '', 0, '', 0, 0, 0, 0),
...
(9, 0, 1, 1, 3, 1, 'news', 'theme_1', 0, '', 1, 0, 0, 0),
(24, 0, 1, 1, 4, 1, 'news', 'theme_3', 0, '', 0, 0, 0, 0),
(13, 4, 1, 0, 0, 2, 'sanpham', '', 0, '', 0, 0, 0, 0),
(14, 0, 1, 0, 0, 1, 'video', '', 0, '', 0, 0, 0, 0),
(25, 0, 1, 0, 5, 1, 'news', 'theme_2', 0, '', 0, 0, 0, 0),
(15, 0, 1, 0, 0, 1, 'other', '', 0, '', 0, 0, 0, 0),
(16, 0, 1, 0, 0, 1, 'other', '', 0, '', 0, 0, 0, 0),
(19, 4, 1, 0, 0, 2, 'sanpham', '', 0, '', 0, 0, 0, 0),
(20, 4, 1, 0, 0, 2, 'sanpham', '', 0, '', 0, 0, 0, 0),
(21, 4, 1, 0, 0, 2, 'sanpham', '', 0, '', 0, 0, 0, 0),
(22, 4, 1, 0, 0, 2, 'sanpham', '', 0, '', 0, 0, 0, 0),
(23, 4, 1, 0, 0, 2, 'sanpham', '', 0, '', 0, 0, 0, 0);
...
(18, 18, 'en', 'Evening Wear', '', 'evening-wear', '', '', '', '', '', ''),
(24, 24, 'en', 'Collaboration/Event', '', 'collaborationevent', '', '', '', '', '', ''),
(4, 4, 'en', 'Women', '', 'women', '', '', '', '', '', ''),
(5, 5, 'en', 'Men', '', 'men', '', '', '', '', '', ''),
...
(25, 25, 'en', 'News', '', 'news', '', '', '', '', '', ''),
(12, 12, 'en', 'Bridal', '', 'bridal', '', '', '', '', '', ''),
(13, 13, 'en', 'Prom', '', 'prom', '', '', '', '', '', ''),
(14, 14, 'en', 'Show fashion', '', 'show-fashion', '', '', '', '', '', ''),
(15, 15, 'en', 'Size', '', 'size', '', '', '', '', '', ''),
(16, 16, 'en', 'MÃ u', '', 'mau', '', '', '', '', '', ''),
(19, 19, 'en', 'Ready-to-wear', '', 'ready-to-wear', '', '', '', '', '', ''),
(20, 20, 'en', 'Foot wear', '', 'foot-wear', '', '', '', '', '', ''),
(21, 21, 'en', 'Swim Wear', '', 'swim-wear', '', '', '', '', '', ''),
(22, 22, 'en', 'Lingerie', '', 'lingerie', '', '', '', '', '', ''),
(23, 23, 'en', 'Accessories', '', 'accessories', '', '', '', '', '', '');
...
(18, 18, 'en', 'Demo Fashion', 'Demo Fashion', '', '', '', '', '', 'demo-fashion-s18.html', '', '', '102', '98.96', '0'),
...
(32, 32, 'en', 'Charity / Fundraising', 'Charity / Fundraising', '', '', '', '', '', 'charity-fundraising.html', '', '', '0', '0', '0'),
(33, 33, 'en', 'Event Production', 'Event Production', '', '', '', '', '', 'event-production.html', '', '', '0', '0', '0'),
(34, 34, 'en', 'Social Media Influencer', 'Social Media Influencer', '', '', '', '', '', 'social-media-influencer.html', '', '', '0', '0', '0'),
(35, 35, 'en', 'Brand Ambassador Program', 'Brand Ambassador Program', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sollicitudin enim vel consectetur bibendum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus viverra neque id nunc posuere facilisis. Suspendisse tincidunt justo diam, viverra pharetra eros ullamcorper at. Suspendisse lacinia, eros vel volutpat accumsan, urna ligula mollis nisl, et fringilla felis felis non enim. Sed posuere in lectus a luctus. Aenean semper diam nibh, ac porta nisl semper quis. Quisque facilisis risus ac quam iaculis efficitur. In sit amet ullamcorper dolor. Aliquam at mauris at ante venenatis semper.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sollicitudin enim vel consectetur bibendum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus viverra neque id nunc posuere facilisis. Suspendisse tincidunt justo diam, viverra pharetra eros ullamcorper at. Suspendisse lacinia, eros vel volutpat accumsan, urna ligula mollis nisl, et fringilla felis felis non enim. Sed posuere in lectus a luctus. Aenean semper diam nibh, ac porta nisl semper quis. Quisque facilisis risus ac quam iaculis efficitur. In sit amet ullamcorper dolor. Aliquam at mauris at ante venenatis semper.', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sollicitudin enim vel consectetur bibendum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus viverra neque id nunc posuere facilisis. Suspendisse tincidunt justo diam, viverra pharetra eros ullamcorper at. Suspendisse lacinia, eros vel volutpat accumsan, urna ligula mollis nisl, et fringilla felis felis non enim. Sed posuere in lectus a luctus. Aenean semper diam nibh, ac porta nisl semper quis. Quisque facilisis risus ac quam iaculis efficitur. In sit amet ullamcorper dolor. Aliquam at mauris at ante venenatis semper.</p>\r\n\r\n<p>Suspendisse potenti. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum neque ac leo ultricies, id varius risus posuere. Curabitur eu ligula ante. Aenean aliquet vel risus a hendrerit. Aenean eu elementum purus. Nulla vehicula condimentum dapibus. Phasellus mattis, nunc elementum venenatis ornare, nisi justo auctor augue, quis ullamcorper arcu nisl eu nunc. Phasellus lobortis dolor ac dui ultrices condimentum. Donec eu ultricies purus. Nam justo mi, rhoncus vel ullamcorper at, laoreet a lorem. In ornare, libero sed dictum scelerisque, purus massa iaculis magna, at varius metus dui lacinia sapien.</p>\r\n', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sollicitudin enim vel consectetur bibendum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus viverra neque id nunc posuere facilisis. Suspendisse tincidunt justo diam, viverra pharetra eros ullamcorper at. Suspendisse lacinia, eros vel volutpat accumsan, urna ligula mollis nisl, et fringilla felis felis non enim. Sed posuere in lectus a luctus. Aenean semper diam nibh, ac porta nisl semper quis. Quisque facilisis risus ac quam iaculis efficitur. In sit amet ullamcorper dolor. Aliquam at mauris at ante venenatis semper.</p>\r\n\r\n<p>Suspendisse potenti. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum neque ac leo ultricies, id varius risus posuere. Curabitur eu ligula ante. Aenean aliquet vel risus a hendrerit. Aenean eu elementum purus. Nulla vehicula condimentum dapibus. Phasellus mattis, nunc elementum venenatis ornare, nisi justo auctor augue, quis ullamcorper arcu nisl eu nunc. Phasellus lobortis dolor ac dui ultrices condimentum. Donec eu ultricies purus. Nam justo mi, rhoncus vel ullamcorper at, laoreet a lorem. In ornare, libero sed dictum scelerisque, purus massa iaculis magna, at varius metus dui lacinia sapien.</p>\r\n', '', 'brand-ambassador-program.html', '', '', '0', '0', '0');
...
(13, 'email', 'herohandsome2013@gmail.commmm', 'OTHER', 'none', 'Email', 0, 1),
...
(2, 'Nguyen Tran Bao', 'herohandsome2013@gmail.com', 'NOi dung ne', '', '', '', '', 0, 1593785520, 1, 'APPLY_NOW', 'APPLY NOW', 0, '', 0, '09/09/2991', '', ''),
(3, 'Tran Tran Bao', 'herohandsome2013@gmail.com', 'Noi dung', '', '', '', '', 0, 1593785703, 0, 'APPLY_NOW', 'APPLY NOW', 0, '', 0, '09/09/0009', '', '');
...
('po7', '0', 'post', 1, 0, 'About us', 'about-us.html', '', ''),
('p3', '0', 'page', 1, 0, 'Collection', 'collection.html', '', ''),
('24', '0', 'postcat', 1, 0, 'Collaboration/Event', 'collaborationevent', '', ''),
('5', '0', 'postcat', 2, 0, 'Men', 'men', '', ''),
('4', '0', 'postcat', 2, 0, 'Women', 'women', '', ''),
('p8', '0', 'page', 2, 0, 'Bag', 'bag.html', '', ''),
('25', '0', 'postcat', 2, 0, 'News', 'news', '', ''),
('p5', '0', 'page', 2, 0, 'Contact us', 'contact-us.html', '', ''),
('po7', '0', 'post', 3, 0, 'About us', 'about-us.html', '', ''),
('p3', '0', 'page', 3, 0, 'Collection', 'collection.html', '', ''),
('24', '0', 'postcat', 3, 0, 'Collaboration/Event', 'collaborationevent', '', ''),
('4', '0', 'postcat', 3, 0, 'Women', 'women', '', ''),
('18', '4', 'postcat', 3, 0, 'Evening Wear', 'evening-wear', '', ''),
('12', '4', 'postcat', 3, 0, 'Bridal', 'bridal', '', ''),
('13', '4', 'postcat', 3, 0, 'Prom', 'prom', '', ''),
('19', '4', 'postcat', 3, 0, 'Ready-to-wear', 'ready-to-wear', '', ''),
('20', '4', 'postcat', 3, 0, 'Foot wear', 'foot-wear', '', ''),
('21', '4', 'postcat', 3, 0, 'Swim Wear', 'swim-wear', '', ''),
('22', '4', 'postcat', 3, 0, 'Lingerie', 'lingerie', '', ''),
('23', '4', 'postcat', 3, 0, 'Accessories', 'accessories', '', ''),
('5', '0', 'postcat', 3, 0, 'Men', 'men', '', ''),
('25', '0', 'postcat', 3, 0, 'News', 'news', '', ''),
('p5', '0', 'page', 3, 0, 'Contact us', 'contact-us.html', '', ''),
('14', '0', 'postcat', 3, 0, 'Show fashion', 'show-fashion', '', '');
...
('127.0.0.1', '1596851371', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36', 0);
...
(5, 5, 'en', 'Contact us', '', '', '', '', '', '', 'contact-us.html'),
...
--
-- AUTO_INCREMENT cho bảng `media_folder`
--
ALTER TABLE `media_folder`
